...
var FIXED_DASHBOARD_ALLOWED_METHODS_ = {
  ...
  getGeminiQASettings: true,
  getGeminiQAHistory: true,
  getNotifySettings: true,
  getScheduleList: true,
  diagnoseNotifySystem: true,
  ...
  saveGeminiQASettings: true,
  saveNotifySettings: true,
  saveScheduleRow: true,
...
function secureDashboardCall_FIXED(method, args, request) {
  ...
  switch (name) {
    ...
    case "getGeminiQASettings": return getGeminiQASettings.apply(null, argv);
    case "getGeminiQAHistory": return getGeminiQAHistory.apply(null, argv);
    case "getNotifySettings": return getNotifySettings.apply(null, argv);
    case "getScheduleList": return getScheduleList.apply(null, argv);
    case "diagnoseNotifySystem": return diagnoseNotifySystem.apply(null, argv);
    ...
    case "testGeminiQA": return testGeminiQA.apply(null, argv);
    case "initNotifySystem": return initNotifySystem.apply(null, argv);
    ...
    case "saveGeminiQASettings": return saveGeminiQASettings.apply(null, argv);
    case "saveNotifySettings": return saveNotifySettings.apply(null, argv);
    case "saveScheduleRow": return saveScheduleRow.apply(null, argv);
    case "deleteScheduleRow": return deleteScheduleRow.apply(null, argv);
