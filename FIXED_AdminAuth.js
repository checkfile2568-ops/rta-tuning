 ...
 * - ไม่ฝังค่า WEB_ADMIN_KEY ใน repository; อ่านจาก Script Properties หรือคอนฟิกเดิม
...
function fixedAdminAuthConfiguredKey_() {
  ...
  throw new Error("WEB_ADMIN_KEY is not configured in Script Properties or existing settings");
}
