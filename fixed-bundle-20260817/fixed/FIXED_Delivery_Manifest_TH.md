...
| WEB_ADMIN_KEY | ใช้ค่าคอนฟิกเดิมของระบบจริง ไม่ฝังค่าไว้ใน repository |
| Spreadsheet production | ไม่ได้เปิดเพื่อเขียนหรือ repair |
| Spreadsheet staging ที่กำหนดในคู่มือ | ใช้สำเนา staging ที่ผู้ดูแลกำหนด ไม่ฝัง ID ไว้ใน repository public |
